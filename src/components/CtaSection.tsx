...
export default function CtaSection() {
  ...
  return (
    <section className="cta-prime-section position-relative overflow-hidden">
      <div className="container position-relative" style={{ zIndex: 5 }}>
        <div className="cta-prime-card position-relative overflow-hidden">
          ...
          <div className="row align-items-center g-4 position-relative" style={{ zIndex: 3 }}>
            {/* Left Content Area */}
            <div className="col-lg-7 col-md-12">
              <div className="cta-content-inner p-4 p-md-5">
                {/* Pill Tag */}
                ...
                <div className="d-flex flex-wrap gap-3 align-items-center">
                  <button
                    ...
                    style={{ padding: "14px 30px", fontSize: "15px", border: "none", cursor: "pointer" }}
                  >
            ...
            <div className="col-lg-5 col-md-12 text-center text-lg-end position-relative">
              <div className="cta-car-visual-box pe-lg-4">
                <img
